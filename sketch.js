...
function setup() {
  ...
  //gamestateendimage = createSprite(600,300);
  //gamestateendimage.addImage();
  //gamestateendimage.scale = 2.5;
  //gamestateendimage.visible = false;
...
function draw() {
  ...
  if(gameState==="play"){
   ...
   player.isTouching(wall15) ||player.isTouching(wall16)||
   player.isTouching(wall17) ||player.isTouching(wall18)||
  ...
  if(gameState === "end"){
    ...
    gamestateendimage.visible = true;
